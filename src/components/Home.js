    ...
    return ( 
        <div className="home h-full bg-white">
            ...
            <div className="p-6 w-full bg-[url('./images/bg8.jpg')] bg-no-repeat bg-cover bg-center items-center space-y-4 lg:px-24 lg:space-y-4 lg:justify-around lg:h-[28rem] lg:max-h-[29rem]">
                <h1 class="top-3 text-green-600 font-bold text-3xl lg:text-5xl lg:max-w-4xl">Welcome to...<br/><p className="text-black text-justify text-lg lg:text-xl">
                ...
                <h1><NavLink className="p-2 border-2 text-white rounded-lg  bg-black hover:bg-green-600  ease-in duration-500"><b>Learn More......</b></NavLink></h1>

                <ul className="flex lg:pt-10">
                    <FaAt className="text-3xl lg:text-4xl text-black hover:text-green-600 ease-in duration-500"/>
                    <Link to="https://twitter.com"><FaTwitter className="text-3xl lg:text-4xl text-black ml-4 lg:ml-20 hover:text-green-600 ease-in duration-500"/></Link>
                    <Link to="https://instagram.com"><FaInstagram className="text-3xl lg:text-4xl text-black ml-4 lg:ml-20 hover:text-green-600 ease-in duration-500"/></Link>
                    <Link to="https://linkedin.com"><FaLinkedin className="text-3xl lg:text-4xl text-black ml-4 lg:ml-20 hover:text-green-600 ease-in duration-500"/></Link>
                </ul>
            </div>
            <div className="apps bg-sky-600 px-6 py-4 items-center text-white lg:flex lg:px-24 lg:space-x-10">
